...
const Form = ({ placeholder, isComment, postId }) => {
    ...
    }, [body, mutatePosts, mutatePost, isComment, postId, mutateComments]);


  return (
    <div className='border-b-[1px] border-neutral-600 px-5 py-2'>
        {currentUser ? (
      ...
      <div className='py-8'>
        <h1 className='text-white text-2xl text-center mb-4 font-bold'>Welcome to Dembu Social</h1>
